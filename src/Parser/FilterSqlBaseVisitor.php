...
/**
 * This class provides an empty implementation of {@see FilterSqlVisitor},
 * which can be extended to create a visitor which only needs to handle a subset
 * of the available methods.
 */
class FilterSqlBaseVisitor extends AbstractParseTreeVisitor implements FilterSqlVisitor
{
	/**
	 * {@inheritdoc}
	 *
